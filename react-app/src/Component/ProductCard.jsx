...
//   const [addedToCart, setAddedToCart] = useState(false); // For animation
...
//     // Animate the button
//     setAddedToCart(true);
//     setTimeout(() => setAddedToCart(false), 1500); // After 1.5 seconds, reset
//   };
...
//       <button onClick={(e) => { e.preventDefault(); handleAddToCart(); }} className="btn-cart">
//         {addedToCart ? "✔️ Added!" : "🛒 Add to Cart"}
//       </button>
//       <button onClick={(e) => { e.preventDefault(); onAddToWishlist(); }} className="btn-wishlist">
//         ❤️ Wishlist
//       </button>
//     </div>
